    ...
    <section className=" transition-all duration-500 max-w-[80px] lg:max-w-[250px] w-full  h-[100vh]  lg:p-5 py-5 px-3 s sticky z-20 bg-white left-0 top-0 ">
        ...
        <ul className="mt-10 flex flex-col justify-center  gap-2">
          ...
          :<li className={`${active=='post-job'?' custom-gradient backdrop-blur-md hover:bg-opacity-20 shadow-lg transition-transform transform   text-white text-lg font-medium':'inset-box-shadow'} rounded-xl border-[1px] border-gray-100 `}>
            ...
            >
             ...
             {
            userType=='jobseeker'?<li className={`${active=='my-profile'?' custom-gradient backdrop-blur-md hover:bg-opacity-20 shadow-lg transition-transform transform   text-white text-lg font-medium':'inset-box-shadow'} rounded-xl border-[1px] border-gray-100 `}>
            <Link
              to={"/my-profile"}
              className="flex  py-4 items-center  px-5 gap-2.5  cursor-pointer  text-[16px]"
            >
          ...
          :<li className={`${active=='company-profile'?' custom-gradient backdrop-blur-md hover:bg-opacity-20 shadow-lg transition-transform transform   text-white text-lg font-medium':'inset-box-shadow'} rounded-xl border-[1px] border-gray-100 `}>
          <Link
            to={"/company-profile"}
            className="flex  py-4 items-center  px-5 gap-2.5  cursor-pointer  text-[16px]"
          >
      ...
      <div className="flex lg:hidden flex-col h-[94%] mt-3">
        <ul className="mt-10 flex flex-col justify-center gap-2">
          ...
          {
            userType == 'jobseeker' ? <li className={`${active=='my-profile'?' custom-gradient backdrop-blur-md hover:bg-opacity-20 shadow-lg transition-transform transform   text-white text-lg font-medium':'inset-box-shadow'} rounded-full lg:rounded-xl border-[1px] border-gray-100 `}>
            ...
            <li className={`${active=='company-profile'?' custom-gradient backdrop-blur-md hover:bg-opacity-20 shadow-lg transition-transform transform   text-white text-lg font-medium':'inset-box-shadow'} rounded-full lg:rounded-xl border-[1px] border-gray-100 `}>
