...
const Card1 = () => {
  return (
    <div className="flex items-center h-[500px]  relative gap-4">
      <div className="w-[50%] bg-cyan-200 h-[95%] rounded-2xl flex items-center justify-center p-4">
          ...
          <ul className="flex flex-col  gap-7  mt-4.5">
            <li className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="icon">
                  <FaFileAlt color="#D07ECE"  className="text-[19px]"/>
                </div>
            ...
            <li className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="icon">
                  <PiFolderSimpleUserBold color="#FF68A4" className="text-[20px]" />
                </div>
      ...
      <CardContent
        icon={<ImFilesEmpty className="text-[44px] text-pink-500" />}
